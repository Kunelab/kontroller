...
/**
 * The one HID report descriptor this app registers.
 *
 * It used to sit alongside ten others -- MOUSE_ABSOLUTE, KEYBOARD, MOUSE_RELATIVE and four
 * MOUSE_RELATIVE_WITH_SCROLL variants among them -- left over from working out which shape
 * a host would accept. None were referenced, but as `val`s on an object they were still
 * compiled in and allocated on first touch, and they made it genuinely hard to tell which
 * descriptor the app actually speaks. Only the combo survives.
 */
