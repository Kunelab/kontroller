package io.github.maximepinard.maxkontroller.reports
...
class KeyboardReport (
    ...
    companion object {
        ...
        /** Android keycode to HID Keyboard/Keypad usage, as US-QWERTY key *positions*. */
        ...
        fun usageFor(keyCode: Int): Int? = KeyEventMap[keyCode]
    }
}
